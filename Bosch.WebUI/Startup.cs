...
using Bosch.WebUI.Consumer.Data;
using Bosch.WebUI.Consumer.Data.Interface;
using Bosch.WebUI.Services;
...
namespace Bosch.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.BaseAddress = new Uri(Configuration.GetSection("ProductHttpClient")["BaseAddress"]);
